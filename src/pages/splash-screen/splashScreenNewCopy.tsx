  ...
  const [searchParams] = useSearchParams();
    ...
    useEffect (() => {
        const fetchUserData = async () => {
          let getUserData
          if(referralCode) {
            getUserData = await axios.post(`${import.meta.env.VITE_APP_URL}/get-user-data`, {user, referralCode})
          } else {
            getUserData = await axios.post(`${import.meta.env.VITE_APP_URL}/get-user-data`, {user})
          }
