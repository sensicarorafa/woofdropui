...
const HomeTab = () => {
    ...
    // const [socialBoostTasks, setSocialBoostTasks] = useState<any>(getUserCookiesParsed ? getUserCookiesParsed?.data?.userData?.socialRewardBoostDeets : []);
...
//end boost states
    ...
    console.log("datas", boostActivated, boostReferralPoints, totalBoostPoints)
        ...
        <div className="flex flex-col  items-center w-full justify-end  h-[100%] overflow-hidden">
            ...
            <div className="flex flex-col  w-full overflow-y-auto h-[100%]">
                ...
                <div className='bg-[#180026] rounded-md py-4'>
                    ...
                    >
                        <SwiperSlide>
                            <div className="flex w-[100px] overflow-hidden pt-3 relative h-[130px] flex-col rounded-lg justify-top align-center items-center text-white border-[#FFE2A7] border-[1px]">
                                ...
                                <div className='flex flex-col justify-center align-center items-center py-2'>
                                    <p className='text-sm small-mobile:text-[12px] leading-none'>Daily Check-in</p>
                                    <p className='text-[10px] text-[#FEC95E] leading-none'>+15000 $AIDOGS</p>
                                </div>
                        ...
                        <SwiperSlide>
                            <div className='flex w-[100px] overflow-hidden relative  h-[130px] pt-3 flex-col rounded-lg justify-top align-center items-center text-white border-[#FFE2A7] border-[1px] '>
                                <div className=" w-[50%] small-mobile:w-[40%] mobile:w-[45%]">
                                    <img className="w-full" src={Trophy} alt="" />
                                </div>
                                <div className='flex flex-col justify-center align-center items-center py-2'>
                                    <p className='text-sm small-mobile:text-[12px] leading-none'>Special Tasks</p>
                                    <p className='text-[10px] text-[#FEC95E] leading-none'>+21000 $AIDOGS</p>
