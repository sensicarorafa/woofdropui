...
const TaskCategorized:FC<any> = ({ tasks, updateTaskStatus, category }) => {
    ...
    return (
        <div>
            {tasks.map((task: any) => (
                !task.rewardClaimed && task.taskUrl.length > 0 && task.taskCategory === category && task.taskStatus !== 'paused' &&
...
export default TaskCategorized;
